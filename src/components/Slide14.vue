...
const routes = [
  ...
  },
  {
    ...
    tagline: "讓整個系統穩穩地跑起來",
    content:
      "利用現成的雲端平台（如 AWS, Azure, Google Cloud Platform）來架設和維護伺服器、資料庫、網路等環境。確保應用程式不會因為流量暴增或系統故障而崩潰，讓用戶隨時都能順暢使用。",
  },
  {
    name: "全端工程師",
    color: "#00897b",
  ...
  },
  {
    ...
    tagline: "讓機器變聰明",
    content:
      "分成應用開發和模型訓練兩個方向。應用開發是直接用現成的 AI（如 ChatGPT）來做產品。模型訓練是拿現有的 AI 模型，餵它吃特定的資料，讓它變專業。",
  },
];
</script>
